---
query: "inheritance of foreigners in turkey"
...
focusKeyword: "Turkish inheritance law for foreigners"
secondaryKeywords:
  - "Turkish inheritance law"
  - "foreigner inheritance Turkey"
  - "inheritance process Turkey"
  - "Turkish Civil Code inheritance"
  - "wills in Turkey for foreigners"
  - "inheritance tax Turkey"
  - "real estate inheritance Turkey"
  - "conflict of laws Turkey"
featuredImagePrompt: "A professional, clean image depicting legal documents, a pen, a calculator, and a small model of a house on a desk. The setting should be a modern law office, conveying trust and expertise. Soft, natural lighting. No text or people."
---
...
- **Turkish real estate lawyer** → `/contact` — For expert assistance with complex inheritance matters.
- **inheritance law in Turkey** → `/articles/inheritance-law-overview` — For a broader understanding of general inheritance principles.
- **property due diligence in Turkey** → `/articles/property-due-diligence-turkey` — To understand the importance of verifying assets and liabilities.
- **buying property in Turkey** → `/articles/buying-property-in-turkey` — If you are considering acquiring assets that will be subject to these laws.
- **Turkish citizenship by investment** → `/articles/turkish-citizenship-by-investment` — For those interested in the benefits of Turkish nationality through property.
- **Turkish real estate lawyer** → `/contact` — For assistance with drafting a legally sound Turkish will.
- **inheritance law in Turkey** → `/articles/inheritance-law-overview` — To delve deeper into the specific legal framework governing inheritance.
...
```json
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can a foreigner make a valid will in Turkey?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, a foreigner can make a valid will in Turkey. However, for it to be effective and enforceable under Turkish law, especially concerning immovable property located in Turkey, it must comply with the formal requirements of the Turkish Civil Code. This usually involves drafting the will before a Turkish notary public or in a specific format with witnesses. It is also crucial that the will respects the \"forced heir\" portions of certain statutory heirs under Turkish law."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if a foreigner dies in Turkey without a will?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If a foreigner dies in Turkey without a valid will (intestate), Turkish statutory inheritance law will apply to all immovable property located in Turkey. For movable property (e.g., bank accounts), the Turkish International Private and Procedural Law generally dictates that the national law of the deceased will apply. The deceased's statutory heirs, as defined by Turkish law (for immovable property) or their national law (for movable property), will inherit the assets according to their prescribed shares. This process can be more complex and time-consuming than if a valid will were in place."
      }
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, if you inherit assets located in Turkey, you are generally subject to Turkish inheritance tax (Veraset ve İntikal Vergisi), regardless of your nationality or the nationality of the deceased. The tax rates are progressive, meaning they increase with the value of the inherited assets, and vary based on the relationship between the heir and the deceased. A tax declaration must be filed within specific deadlines, and taxes must be paid accordingly."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The duration of the inheritance process in Turkey can vary significantly. Simple cases, where all heirs are known, documents are readily available, and there are no disputes, might be resolved within a few months. However, more complex situations involving numerous heirs, missing documents, international legalizations, disputes among heirs, or significant assets can extend the process to several years. Legal assistance can help streamline the process and mitigate delays."
      }
    },
    {
      "@type": "Question",
      "name": "Can I inherit property in Turkey if I am not a Turkish citizen?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, non-Turkish citizens can inherit property in Turkey. Turkish inheritance law applies to immovable property located in Turkey, and there are generally no nationality-based restrictions on inheriting real estate, subject to standard legal procedures and any specific limitations (e.g., properties within military zones, though these are less common for individual ownership now). The process will involve obtaining a Certificate of Inheritance and registering the property in the heir's name at the Land Registry Office."
      }
